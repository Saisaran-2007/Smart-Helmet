  ...
  return (
    <div className="help-page page-enter">
      ...
      <div className="help-grid">
        <section className="help-card"><div className="help-card-heading"><div className="help-icon blue"><ShieldCheck size={19} /></div><div><h4>Using Helmetra</h4><span>Quick software guide</span></div></div><div className="help-steps"><div><b>01</b><strong>Dashboard</strong><span>See your ride status, GPS, battery and protection overview.</span></div><div><b>02</b><strong>Navigation</strong><span>Choose any starting location and any destination, then calculate a route.</span></div><div><b>03</b><strong>Emergency</strong><span>Run an SOS or accident simulation with a 10-second cancellation window.</span></div><div><b>04</b><strong>Routes</strong><span>Review the active route and recent ride history.</span></div></div></section>
